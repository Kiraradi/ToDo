...
;// CONCATENATED MODULE: ./src/js/localStorageService.js
...
;// CONCATENATED MODULE: ./src/js/tasksController.js
...
class TasksController {
  ...
  toggleTaskUpdating(taskElement) {
    ...
    const isTaskUpdatingToggle = taskChangeForm.classList.contains("task__change__active");
  ...
  startDragAndDrop() {
    new sortable_esm(this.tasksList, {
      animation: 300
    });
  }
}
